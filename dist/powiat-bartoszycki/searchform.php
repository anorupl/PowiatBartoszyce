...
<form role="search" method="get" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button type="submit" class="submit" name="submit" id="searchsubmit" value="<?php _e('Search','wpg_theme'); ?>"><span class="screen-reader"><?php _e('Search','wpg_theme'); ?></span><i class="icon-search"></i></button>
</form>
