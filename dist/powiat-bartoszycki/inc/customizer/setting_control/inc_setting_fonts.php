...
$wp_customize->add_control(new Fonts_Dropdown_Google( $wp_customize, 'wpg_body_google_font',array(
...
$wp_customize->add_setting('wpg_body_google_variants',array (
	'default' 			=> $default_font_setting['body_google_variants'],
	'sanitize_callback' => 'wpg_sanitize_font_variant'
));

$wp_customize->add_control(new Fonts_Dropdown_Google( $wp_customize, 'wpg_body_google_variants', array(
...
$wp_customize->add_control(new Fonts_Dropdown_Google( $wp_customize, 'wpg_heading_google_font',array(
...
$wp_customize->add_setting('wpg_heading_google_variants',array (
	'default' 			=> $default_font_setting['heading_google_variants'],
	'sanitize_callback' => 'wpg_sanitize_font_variant'
));

$wp_customize->add_control(new Fonts_Dropdown_Google( $wp_customize, 'wpg_heading_google_variants', array(
	'label' 			=> __('Font Variant','wpg_theme'),
	'description'		=> __('Different variants of the font, provides control over font-weight and italics','wpg_theme'),
...
$wp_customize->add_control(new WPG_Customize_Control_Checkbox_Multiple($wp_customize, 'google_subsets', array(
	'section' 			=> $font_section_id,
