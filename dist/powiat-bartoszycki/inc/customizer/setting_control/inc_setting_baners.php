...
$wp_customize->add_control(new WPG_Customize_Control_Switch($wp_customize, 'wpg_primary_baners_active', array(
...
$wp_customize->add_control(new WPG_Customize_Control_Switch($wp_customize, 'wpg_secondary_baners_active', array(
